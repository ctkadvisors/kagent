...
- Refusal construction (`LLMClientHttpError(0, reason)` at line 609-622, message assigned at 610-621 so the agent-pod's status writer surfaces the reason verbatim): [`packages/agent-loop/src/executor.ts:608-622`](../packages/agent-loop/src/executor.ts).
