...
const expectations: readonly CRDExpectation[] = [
  ...
  },
  {
    ...
    kind: 'Channel',
    plural: 'channels',
    specRequired: ['provider', 'accountId'],
    specProperties: [
      'provider',
      'accountId',
      'displayName',
  ...
  {
    file: 'channelbindings.yaml',
    kind: 'ChannelBinding',
    plural: 'channelbindings',
    specRequired: ['channelRef', 'target'],
    specProperties: ['channelRef', 'match', 'default', 'paused', 'target', 'approval'],
    statusProperties: ['observedGeneration', 'conditions', 'lastMatchedAt'],
  },
  {
    file: 'channelsessions.yaml',
    kind: 'ChannelSession',
    plural: 'channelsessions',
    specRequired: ['channelRef', 'provider', 'accountId', 'peer', 'sessionKey', 'target'],
    specProperties: [
      'channelRef',
      'provider',
      'accountId',
